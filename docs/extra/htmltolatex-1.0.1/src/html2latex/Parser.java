        ...
        while ((c = _reader.read()) != -1) {
            ...
            if (ch == '>') {
                ...
                if (element instanceof ElementStart) {
                    ...
                    //modif julien
                  	//on veut supprimer la numerotation en h1,h2...
                  	if(
                  		str.equals(new String ("h1")) ||
                  		str.equals(new String ("h2")) ||
                  		str.equals(new String ("h3")) ||
                  		str.equals(new String ("h4")) ||
                  		str.equals(new String ("h5"))
                  		){
                  		
                  			int depth = Integer.parseInt(str.substring(1,2));
                  		
                  			//on avance le _reader.read() de depth*2+1
                  			//System.out.println("et oui "+str+ "   depth "+depth);
    ...
    private void readContent(char firstChar) throws IOException {
        ...
        while ((c = _reader.read()) != -1) {
            ...
            if (ch == '<') {
            	...
            	//modif julien il ne faut pas confondre le < d'un tag avec le signe
            	//maths
            	//solution pas terrible: quand espace apres ->math, sinon tag
            	
            	_reader.mark(3);
            	
            	int cnext=_reader.read();
