...
MathJax.Message = {
  ...
  styles: {
    "#MathJax_Message": {
    'background-image': "url('Blue-018-loading.gif')", 
    ...
    position: "fixed", left: "50%", top: "50%",
      ...
      margin: "-25px 0px 0px -25px", padding: "0px 0px 0px 0px",
      'z-index': "102", color: "black", 'font-size': "0px",
...
MathJax.Hub = {
  config: {
    ...
    skipStartupTypeset: true,    // set to true to skip PreProcess and Process during startup
  ...
  Typeset: function (element, callback) {
	//  alert("typeset "+element+"   "+callback);
