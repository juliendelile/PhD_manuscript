...
* cases studies of the different phases of early Zebrafish development

| | | |
:-------------------------:|:-------------------------:|:-------------------------:
![](images/Zebrafish_Development_kane.gif)  |  ![](images/yolk_external.gif)  |  ![](images/yolk_relaxation_cut.gif)
